...
namespace MyPagePrototype.DAL
{
    ...
    public class MinSideInitializer : System.Data.Entity.DropCreateDatabaseAlways<MinSideContext>
    {
        protected override void Seed(MinSideContext context)
        {
            ...
            {
            new Melding{MeldingID= 1,MeldingDato=DateTime.Parse("2012-10-10"), MeldingTittel="Det er oppdaget en feil på din eiendom", MeldingAvsender="Kristiansand kommune", MeldingFilPath="/Resources/Byggesaksmelding.pdf"},
            new Melding{MeldingID= 2,MeldingDato=DateTime.Parse("2012-10-10"), MeldingTittel="Det er oppdaget en feil på din eiendom", MeldingAvsender="Kristiansand kommune", MeldingFilPath="/Resources/Byggesaksmelding.pdf"}
            };
            ...
            {
            new Byggesak{ByggesakID=1, ByggesakTema="Dette er tema", TypeBygg="Bolig", ByggningsNummer=2354, ByggesakTittel="Oppdaget uregistrert bygg på din eiendom", ByggesakDato=DateTime.Parse("2012-10-10"), ByggesakStatus="Ferdig behandlet", NæringsGruppe="Ikke oppgitt", NyHøyde=2, NyttAreal=6, KvitteringID=1},
            ...
            {
            new Bruker{BrukerID=1, Navn="Jarl Jarlesen", Telefonnummer="47474747", Epost="Test@mail.com", MailØnsket=true, Samtykke=true}
            ...
            {
            new KontaktInfo{KontaktInfoID=1, Navn="Jens Jenshus", Telefonnummer="47474747", Epost="Test@mail.com", MailØnsket=true, Samtykke=true},
